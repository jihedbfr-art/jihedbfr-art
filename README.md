...
- 🧩 **[keycloak-spi-workbench](https://github.com/jihedbfr-art/keycloak-spi-workbench)** — custom Keycloak SPI providers, starting with a conditional authenticator that gates a login-flow step on business rules instead of a flat yes/no. Tested against a real Keycloak server via Testcontainers, not just unit-mocked.
